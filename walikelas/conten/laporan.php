...
<div class="w3-container panel panel-default">
<a href="conten/cetak_laporan.php?date=<?php echo $awal;?>&akhir=<?php echo $akhir;?>&kelas=<?php echo $id;?>"><button style="margin-top: 10px; width: 150px" class="btn btn-success fa fa-print">Export</button></a>
