...
<nav class="w3-sidenav w3-collapse w3-blue w3-animate-left" style="z-index:3;width:300px;" id="mySidenav">
  ...
  <a href="?halaman=SMS" class="w3-padding"><i class="fa fa-send-o fa-fw"></i>  Kirim SMS</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  if ($halaman=="kehadiran") {
   ...
   include('conten/sms.php');
  }elseif ($halaman=="editabsen") {
    include('conten/edit_absen.php');
  }
  else { 
    ?>
<header class="w3-container" style="padding-top:22px">
<h3><b><i class="fa fa-users"></i> Selamat Datang Guru Piket</b></h3>
  </header>
  <?php
  }
?>   
