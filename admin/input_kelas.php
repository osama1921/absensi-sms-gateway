...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <center><h5><b><i class="panel-heading"></i> Input Data Kelas</b></h5></center>
  </header>

<center>
<div class="w3-container panel panel-default">
<form method="post" enctype="multipart/form-data" action="aksi/aksi_input_kelas.php" class="panel-body">
<div class="w3-input-grup size">	
	<input name="id" type="text" required="required" class="w3-input " placeholder="Id Kelas" > 
    <br></div>
    <div class="w3-input-grup size">	
	<input name="nama" type="text" required="required" class="w3-input " placeholder="Nama Kelas" > 
    <br></div>
    <div class="w3-input-grup size">	
	<input name="jurusan" type="text" required="required" class="w3-input " placeholder="Jurusan" > 
