...
include('koneksi.php');
$id=$_GET['id'];
$q1=mysql_query("SELECT * FROM `kelas` WHERE id_kelas='$id'");
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <center><h5><b><i class="panel-heading"></i> Edit Data Kelas</b></h5></center>
  </header>

<center>
<div class="w3-container panel panel-default">
<form method="post" enctype="multipart/form-data" action="aksi/aksi_edit_kelas.php?id=<?php echo $data['id_kelas'];?>" class="panel-body">
    <div class="w3-input-grup size">	
Nama Kelas	<input name="nama" type="text" required="required" class="w3-input " value="<?php echo $data['nama_kelas'];?>" > 
    <br></div>
    <div class="w3-input-grup size">	
	Jurusan <input name="jurusan" type="text" required="required" class="w3-input " value="<?php echo $data['jurusan'];?>" > 
	<br></div> <div class="w3-input-grup size">	
	Username <input name="user" type="text" required="required" class="w3-input " value="<?php echo $data['username'];?>" > 
	<br></div> <div class="w3-input-grup size">	
	Password <input name="pass" type="text" required="required" class="w3-input " value="<?php echo $data['password'];?>" > 
	<br></div>
