...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
<a href="siswa.php" class="btn btn-default" style="text-decoration:none">Kembali</a>
<br/><br/>
<?php 
include 'koneksi.php';
?>

<form method="post" enctype="multipart/form-data" action="import/upload_aksi.php">
	Pilih File: 
<div class="w3-input-grup">	
	<input name="filepegawai" type="file" required="required" class="w3-input btn btn-default" > 
	<br></div><br>
	<input name="upload" type="submit" value="Import" class="w3-input btn btn-primary">
</form>
